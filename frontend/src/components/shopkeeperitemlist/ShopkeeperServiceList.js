            ...
            >
              <div className="service_list_sec_s">
                <img
                  ...
                  alt="pi"
                  className="service_img_list_s"
                ></img>
                <div className="about_service_list_s">
                  <div className="service_name_list_s">{data.service_name}</div>
                  <div className="service_des_list_s">
                    <div className="service_des_on_s">{data.service_des}</div>
                    <div className="service_p_e_del">
